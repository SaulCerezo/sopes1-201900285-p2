...
const (
	WeatherService_SendTweets_FullMethodName = "/weather.WeatherService/SendTweets"
)
...
type WeatherServiceClient interface {
	SendTweets(ctx context.Context, in *TweetBatch, opts ...grpc.CallOption) (*Ack, error)
}
...
func (c *weatherServiceClient) SendTweets(ctx context.Context, in *TweetBatch, opts ...grpc.CallOption) (*Ack, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ack)
	err := c.cc.Invoke(ctx, WeatherService_SendTweets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WeatherServiceServer interface {
	SendTweets(context.Context, *TweetBatch) (*Ack, error)
...
func (UnimplementedWeatherServiceServer) SendTweets(context.Context, *TweetBatch) (*Ack, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendTweets not implemented")
}
...
func _WeatherService_SendTweets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TweetBatch)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WeatherServiceServer).SendTweets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WeatherService_SendTweets_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).SendTweets(ctx, req.(*TweetBatch))
	}
...
var WeatherService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SendTweets",
			Handler:    _WeatherService_SendTweets_Handler,
		},
	},
